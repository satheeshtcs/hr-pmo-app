...
export class EnterRoleComponent implements OnInit   {
  user1: Userrole ={
    ...
    constructor(private http: Http,private router:Router,private tservice:ToasterService,private sessiont:SessionStorageService ) { }
    ...
    addNewRole = function(user1){
      this.userObj = {
       ...
       "created_by" : this.sessiont.retrieve("username")
        ...
        this.tservice.Success("Role was successfully added");
      })
