...
import { ArolemapComponent } from './arolemap/arolemap.component';
import { ToasterService } from './toaster.service';
import { Toaster2Service } from './toaster2.service';
import { HyComponent } from './hy/hy.component';
import { HtdetailsComponent } from './htdetails/htdetails.component';
import { HteditComponent } from './htedit/htedit.component';
const appRoutes: Routes = [
 ...
 { path: 'arolemap', canActivate:[AuthGuard], component:ArolemapComponent},
 
 { path: 'hy', canActivate:[AuthGuard], component:HyComponent},
 { path: 'htdetails', canActivate:[AuthGuard], component:HtdetailsComponent},
 { path: 'htedit', canActivate:[AuthGuard], component:HteditComponent}
...
@NgModule({
  ...
  providers: [AppComponent,UserService,AuthGuard,ToasterService,Toaster2Service],
