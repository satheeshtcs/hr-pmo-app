...
import { CtaskComponent } from './ctask/ctask.component';
...
const appRoutes: Routes = [
  ...
  {path: 'ctask',canActivate:[AuthGuard], component: CtaskComponent},
  {path: 'assign',canActivate:[AuthGuard], component: AssignComponent},
  {path: 'assigned',canActivate:[AuthGuard], component: AssignedTasksComponent},
