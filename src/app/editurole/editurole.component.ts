...
export class EdituroleComponent implements OnInit {
  ...
  userData	: any = {};
  userRole : any={};
  constructor(private userService: UserService, private tservice:ToasterService,private dataService:DataService,private http: Http,private router:Router,private sessionst:SessionStorageService) { }
